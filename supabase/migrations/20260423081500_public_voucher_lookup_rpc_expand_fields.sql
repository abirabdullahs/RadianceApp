-- Expand public voucher lookup payload with full display fields
-- (method/ref/note/description/status/date breakdown + batch placeholder).
...
BEGIN
  ...
  WITH q AS (
    SELECT
      ...
      l.payment_type_code,
      l.for_month,
      to_char(l.for_month, 'Mon YYYY') AS month_label,
      l.amount_due,
      l.amount_paid,
      l.discount_amount,
      l.fine_amount,
      (l.amount_due - l.discount_amount + l.fine_amount) AS net_amount,
      l.paid_at,
      l.created_at,
      l.payment_method,
      l.transaction_ref,
